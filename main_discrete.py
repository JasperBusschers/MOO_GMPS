...
def arguments():
    ...
    parse.add_argument('--log_dir', type=str, default="/logs/dsth", help='environment to use')
    ...
    parse.add_argument('--beta_steps', type=int, default=2)
    parse.add_argument('--meta_step_size', type=float, default=0.01)
    ...
    parse.add_argument('--adamSteps', type=int, default=50)
...
def run_experiment(args):
    ...
    algo = MAMLIL(
        ...
        latent_dim=args.ldim,
        dagger=args.dagger,
        save_path="C:\\Users\\jasper\\Documents\\AI\\MOO_GMPS\\logs\\dsth\\",
